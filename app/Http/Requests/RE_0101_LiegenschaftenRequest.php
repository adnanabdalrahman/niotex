...
class RE_0101_LiegenschaftenRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            '*.liegenschaft.mietobjekte.*.wohnFl' => 'nullable|numeric',
            '*.liegenschaft.mietobjekte.*.heizFl' => 'nullable|numeric',
            '*.liegenschaft.mietobjekte.*.wwFl' => 'nullable|numeric',
            '*.liegenschaft.mietobjekte.*.flEinheit' => 'nullable|string|max:30',
