...
class RE_0101_LiegenschaftenRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'liegenschaft.fern' => 'required|in:0,1',
            'liegenschaft.fernAb' => 'nullable|date',
            'liegenschaft.opk' => 'required|in:0,1',
            'liegenschaft.opkAb' => 'required|date',
            'liegenschaft.uvir' => 'required|in:0,1',
            'liegenschaft.uvirAb' => 'required|date',
            'liegenschaft.mdf' => 'required|numeric|digits_between:1,2',
            'liegenschaft.mdfBis' => 'nullable|date',
            'liegenschaft.lgnrExt' => 'required|string|max:20',
            ...
            'liegenschaft.adressen.*.lgStr' => 'required|string|max:70',
            'liegenschaft.adressen.*.lgPlz' => 'required|string|max:10',
            'liegenschaft.adressen.*.lgOrt' => 'required|string|max:40',
            ...
            'liegenschaft.kunden.*.kdart' => 'required|string|max:3',
            ...
            'liegenschaft.mietobjekte.*.mLage' => 'required|string|max:60',
            'liegenschaft.mietobjekte.*.tplnr' => 'required|string|max:30',
            'liegenschaft.mietobjekte.*.mdmIdMe' => 'required|numeric',
            'liegenschaft.mietobjekte.*.korrnrHk' => 'required|string|max:20',
            'liegenschaft.mietobjekte.*.korrnrKw' => 'required|string|max:20',
            ...
            'liegenschaft.mieter.*.datumEinzug' => 'nullable|date',
            ...
            'liegenschaft.abrechnungsdaten.*.sttHka' => 'required|string|max:5',
