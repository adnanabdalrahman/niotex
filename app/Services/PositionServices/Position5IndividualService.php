...
{
    public function savePosition5Individual($data, $internePositionsnummer): bool
    {
        return Position5Individual::insert(
            [
                ...
                'PosIndividualD6' => $data['PosIndividualD6'] ?? null,//gepackte menge
     ...
     */
    public function updatePosition5Individual($data, $internePositionsnummer): Position5Individual
    {
        try {
            ...
            throw new DBSaveException('Fehler beim Speichern oder Aktualisieren die PositionWert: ' . $e->getMessage());
        }
    }
