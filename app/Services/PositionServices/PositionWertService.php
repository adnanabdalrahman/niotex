...
{
    public function savePositionWert($data, $internePositionsnummer): bool
    {
        return PositionWert::insert(
            [
     ...
     */
    public function updatePositionWert($data, $internePositionsnummer): PositionWert
    {
        try {
