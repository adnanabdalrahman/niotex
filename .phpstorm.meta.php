...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.db_connection_sqlsrv' => 'string',
            ...
            'filesystems.disks.dl_buchung.root' => 'string',
            'filesystems.disks.dl_buchung.throw' => 'boolean',
            'filesystems.links.D:\xampp\htdocs\ceosapi\public\storage' => 'string',
            ...
            'logging.channels.incoming_requests.driver' => 'string',
            'logging.channels.incoming_requests.path' => 'string',
            'logging.channels.incoming_requests.level' => 'string',
            'logging.channels.incoming_requests.days' => 'string',
            'logging.channels.incoming_requests.replace_placeholders' => 'boolean',
            'logging.channels.outcoming_requests.driver' => 'string',
            'logging.channels.outcoming_requests.path' => 'string',
            'logging.channels.outcoming_requests.level' => 'string',
            'logging.channels.outcoming_requests.days' => 'string',
            'logging.channels.outcoming_requests.replace_placeholders' => 'boolean',
            'mail.default' => 'string',
            ...
            'sap.base_url' => 'string',
            'sap.client_id' => 'string',
            'sap.client_secret' => 'string',
            'sap.api_token' => 'string',
            'sap.mm221_path' => 'string',
            'sap.mm341_path' => 'string',
            'sap.mm331_path' => 'string',
            'sap.mm352_path' => 'string',
            'sap.sd0102_path' => 'string',
            'sap.sd0301_path' => 'string',
            'sap.se2601_path' => 'string',
            'sap.co0101_path' => 'string',
            'sap.ea21_path' => 'string',
            'sap.ea11_path' => 'string',
            ...
            'services.dl_buchungsdatei.path' => 'string',
...
'app.db_connection_sqlsrv','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider',
...
'cache.prefix','ceosweb.api_token','database.default','database.connections.sqlite.driver','database.connections.sqlite.url',
...
'database.connections.pgsql.prefix_indexes','database.connections.pgsql.search_path','database.connections.pgsql.sslmode','database.connections.sqlsrv.driver','database.connections.sqlsrv.host',
'database.connections.sqlsrv.instanceName','database.connections.sqlsrv.port','database.connections.sqlsrv.database','database.connections.sqlsrv.username','database.connections.sqlsrv.password',
'database.connections.sqlsrv.charset','database.connections.sqlsrv.collation','database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.sqlsrv.encrypt',
...
'filesystems.disks.dl_buchung.driver','filesystems.disks.dl_buchung.root','filesystems.disks.dl_buchung.throw','filesystems.links.D:\\xampp\\htdocs\\ceosapi\\public\\storage','ide-helper.filename',
...
'individual.VorIndividual.VorIndividualC1','individual.VorIndividual.VorIndividualC2','individual.VorIndividual.VorIndividualC3','individual.VorIndividual.VorIndividualC4','individual.VorIndividual.VorIndividualC5',
'individual.VorIndividual.VorIndividualD6','individual.PosIndividual','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'logging.channels.emergency.path','logging.channels.incoming_requests.driver','logging.channels.incoming_requests.path','logging.channels.incoming_requests.level','logging.channels.incoming_requests.days',
'logging.channels.incoming_requests.replace_placeholders','logging.channels.outcoming_requests.driver','logging.channels.outcoming_requests.path','logging.channels.outcoming_requests.level','logging.channels.outcoming_requests.days',
'logging.channels.outcoming_requests.replace_placeholders','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme','mail.mailers.smtp.url',
...
'mail.markdown.theme','mail.markdown.paths','openapi.collections.default.info.title','openapi.collections.default.info.description','openapi.collections.default.info.version',
'openapi.collections.default.info.contact','openapi.collections.default.servers.0.url','openapi.collections.default.servers.0.description','openapi.collections.default.servers.0.variables','openapi.collections.default.tags.0.name',
'openapi.collections.default.tags.0.description','openapi.collections.default.tags.0.externalDocs.description','openapi.collections.default.tags.0.externalDocs.url','openapi.collections.default.security','openapi.collections.default.extensions',
'openapi.collections.default.route.uri','openapi.collections.default.route.middleware','openapi.collections.default.middlewares.paths','openapi.collections.default.middlewares.components','openapi.locations.callbacks',
'openapi.locations.request_bodies','openapi.locations.responses','openapi.locations.schemas','openapi.locations.security_schemes','queue.default',
...
'queue.connections.redis.block_for','queue.connections.redis.after_commit','queue.connections.sqlsrv_queue.driver','queue.connections.sqlsrv_queue.connection','queue.connections.sqlsrv_queue.table',
'queue.connections.sqlsrv_queue.queue','queue.connections.sqlsrv_queue.retry_after','queue.connections.sqlsrv_queue.after_commit','queue.batching.database','queue.batching.table',
'queue.failed.driver','queue.failed.database','queue.failed.table','sap.base_url','sap.client_id',
'sap.client_secret','sap.api_token','sap.mm221_path','sap.mm341_path','sap.mm331_path',
'sap.mm352_path','sap.sd0102_path','sap.sd0301_path','sap.se2601_path','sap.co0101_path',
'sap.ea21_path','sap.ea11_path','services.postmark.token','services.ses.key','services.ses.secret',
'services.ses.region','services.resend.key','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.dl_buchungsdatei.path',
...
'session.partitioned','vorgruppeMapping.RT1SM','vorgruppeMapping.NA1SM','vorgruppeMapping.RT1SR','vorgruppeMapping.NA1SR',
'vorgruppeMapping.ENASV','vorgruppeMapping.UVISV','vorgruppeMapping.NA1SV','vorgruppeSKTMapping.ENA','vorgruppeSKTMapping.NA1',
...
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid',
'D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','D:.xampp.htdocs.ceosapi.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'DB_DATABASE','DB_USERNAME','DB_PASSWORD','DB_CONNECTION_SQLSRV','DB_HOST_SQLSRV',
'DB_PORT_SQLSRV','DB_DATABASE_SQLSRV','DB_USERNAME_SQLSRV','DB_PASSWORD_SQLSRV','SESSION_DRIVER',
'SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH','SESSION_DOMAIN','BROADCAST_CONNECTION',
'FILESYSTEM_DISK','QUEUE_CONNECTION','DB_QUEUE_CONNECTION','CACHE_STORE','CACHE_PREFIX',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','SAP_API_TOKEN',
'CEOS_WEB_API_TOKEN','SAP_API_BASE_URL','SAP_CLIENT_ID','SAP_CLIENT_SECRET','DL_BUCHUNGSDATEI_PATH',
'SLACK_BOT_USER_OAUTH_TOKEN','SLACK_BOT_USER_DEFAULT_CHANNEL','SLACK_WEBHOOK_URL',);
