...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.connections.sqlsrv.instanceName' => 'string',
            ...
            'database.connections.sqlsrv.collation' => 'string',
            ...
            'filesystems.disks.dl_buchung.driver' => 'string',
            'filesystems.disks.dl_buchung.root' => 'NULL',
            'filesystems.disks.dl_buchung.throw' => 'boolean',
            'filesystems.links.D:\xampp\htdocs\ceosapi-niotix\public\storage' => 'string',
            ...
            'individual.VorIndividual.VorIndividualC1' => 'string',
            'individual.VorIndividual.VorIndividualC2' => 'string',
            'individual.VorIndividual.VorIndividualC3' => 'string',
            'individual.VorIndividual.VorIndividualC4' => 'string',
            'individual.VorIndividual.VorIndividualC5' => 'string',
            'individual.VorIndividual.VorIndividualD6' => 'string',
            'individual.PosIndividual' => 'array',
            ...
            'logging.channels.niotix_requests.driver' => 'string',
            'logging.channels.niotix_requests.path' => 'string',
            'logging.channels.niotix_requests.level' => 'string',
            'logging.channels.niotix_requests.days' => 'string',
            'logging.channels.niotix_requests.replace_placeholders' => 'boolean',
            'logging.channels.ceosweb_requests.driver' => 'string',
            'logging.channels.ceosweb_requests.path' => 'string',
            'logging.channels.ceosweb_requests.level' => 'string',
            'logging.channels.ceosweb_requests.days' => 'string',
            'logging.channels.ceosweb_requests.replace_placeholders' => 'boolean',
            'mail.default' => 'string',
            ...
            'niotix.base_url' => 'string',
            'niotix.account_id' => 'string',
            'niotix.scope_id' => 'string',
            'niotix.digital_twin_id' => 'string',
            'niotix.api_key' => 'string',
            'niotix.digital_twin_path' => 'string',
            'openapi.collections.default.info.title' => 'string',
            'openapi.collections.default.info.description' => 'NULL',
            'openapi.collections.default.info.version' => 'string',
            'openapi.collections.default.info.contact' => 'array',
            'openapi.collections.default.servers.0.url' => 'string',
            'openapi.collections.default.servers.0.description' => 'NULL',
            'openapi.collections.default.servers.0.variables' => 'array',
            'openapi.collections.default.tags.0.name' => 'string',
            'openapi.collections.default.tags.0.description' => 'string',
            'openapi.collections.default.tags.0.externalDocs.description' => 'string',
            'openapi.collections.default.tags.0.externalDocs.url' => 'string',
            'openapi.collections.default.security' => 'array',
            'openapi.collections.default.extensions' => 'array',
            'openapi.collections.default.route.uri' => 'string',
            'openapi.collections.default.route.middleware' => 'array',
            'openapi.collections.default.middlewares.paths' => 'array',
            'openapi.collections.default.middlewares.components' => 'array',
            'openapi.locations.callbacks' => 'array',
            'openapi.locations.request_bodies' => 'array',
            'openapi.locations.responses' => 'array',
            'openapi.locations.schemas' => 'array',
            'openapi.locations.security_schemes' => 'array',
            ...
            'queue.connections.sqlsrv_queue.driver' => 'string',
            'queue.connections.sqlsrv_queue.connection' => 'string',
            'queue.connections.sqlsrv_queue.table' => 'string',
            'queue.connections.sqlsrv_queue.queue' => 'string',
            'queue.connections.sqlsrv_queue.retry_after' => 'integer',
            'queue.connections.sqlsrv_queue.after_commit' => 'boolean',
            ...
            'services.slack.notifications.bot_user_oauth_token' => 'string',
            'services.slack.notifications.channel' => 'string',
            'services.dl_buchungsdatei.path' => 'NULL',
            ...
            'vorgruppeMapping.RT1SM' => 'string',
            'vorgruppeMapping.NA1SM' => 'string',
            'vorgruppeMapping.RT1SR' => 'string',
            ...
            'vorgruppeSKTMapping.STT' => 'string',
            'vorgruppeSKTMapping.UVI' => 'string',
...
'ceosweb.api_token','database.default','database.connections.sqlite.driver','database.connections.sqlite.url','database.connections.sqlite.database',
...
'database.connections.pgsql.search_path','database.connections.pgsql.sslmode','database.connections.sqlsrv.driver','database.connections.sqlsrv.host','database.connections.sqlsrv.instanceName',
...
'database.connections.sqlsrv.collation','database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.sqlsrv.encrypt','database.connections.sqlsrv.trust_server_certificate',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.dl_buchung.driver',
'filesystems.disks.dl_buchung.root','filesystems.disks.dl_buchung.throw','filesystems.links.D:\\xampp\\htdocs\\ceosapi-niotix\\public\\storage','ide-helper.filename','ide-helper.models_filename',
...
'ide-helper.macroable_traits','individual.VorIndividual.VorIndividualC1','individual.VorIndividual.VorIndividualC2','individual.VorIndividual.VorIndividualC3','individual.VorIndividual.VorIndividualC4',
'individual.VorIndividual.VorIndividualC5','individual.VorIndividual.VorIndividualD6','individual.PosIndividual','logging.default','logging.deprecations.channel',
...
'logging.channels.null.handler','logging.channels.emergency.path','logging.channels.niotix_requests.driver','logging.channels.niotix_requests.path','logging.channels.niotix_requests.level',
'logging.channels.niotix_requests.days','logging.channels.niotix_requests.replace_placeholders','logging.channels.ceosweb_requests.driver','logging.channels.ceosweb_requests.path','logging.channels.ceosweb_requests.level',
'logging.channels.ceosweb_requests.days','logging.channels.ceosweb_requests.replace_placeholders','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','niotix.base_url','niotix.account_id',
'niotix.scope_id','niotix.digital_twin_id','niotix.api_key','niotix.digital_twin_path','openapi.collections.default.info.title',
'openapi.collections.default.info.description','openapi.collections.default.info.version','openapi.collections.default.info.contact','openapi.collections.default.servers.0.url','openapi.collections.default.servers.0.description',
'openapi.collections.default.servers.0.variables','openapi.collections.default.tags.0.name','openapi.collections.default.tags.0.description','openapi.collections.default.tags.0.externalDocs.description','openapi.collections.default.tags.0.externalDocs.url',
'openapi.collections.default.security','openapi.collections.default.extensions','openapi.collections.default.route.uri','openapi.collections.default.route.middleware','openapi.collections.default.middlewares.paths',
'openapi.collections.default.middlewares.components','openapi.locations.callbacks','openapi.locations.request_bodies','openapi.locations.responses','openapi.locations.schemas',
'openapi.locations.security_schemes','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'queue.connections.redis.queue','queue.connections.redis.retry_after','queue.connections.redis.block_for','queue.connections.redis.after_commit','queue.connections.sqlsrv_queue.driver',
'queue.connections.sqlsrv_queue.connection','queue.connections.sqlsrv_queue.table','queue.connections.sqlsrv_queue.queue','queue.connections.sqlsrv_queue.retry_after','queue.connections.sqlsrv_queue.after_commit',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.dl_buchungsdatei.path','session.driver','session.lifetime',
...
'session.secure','session.http_only','session.same_site','session.partitioned','vorgruppeMapping.RT1SM',
'vorgruppeMapping.NA1SM','vorgruppeMapping.RT1SR','vorgruppeMapping.NA1SR','vorgruppeMapping.ENASV','vorgruppeMapping.UVISV',
'vorgruppeMapping.NA1SV','vorgruppeSKTMapping.ENA','vorgruppeSKTMapping.NA1','vorgruppeSKTMapping.RT1','vorgruppeSKTMapping.STT',
'vorgruppeSKTMapping.UVI','tinker.commands','tinker.alias','tinker.dont_alias','tinker.trust_project',);
...
'openapi.default.specification','digital-twins.index','digital-twins.store','digital-twins.show','digital-twins.update',
'digital-twins.destroy','storage.local',);
...
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid',
'D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','D:.xampp.htdocs.ceosapi-niotix.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'LOG_LEVEL','LOG_DAILY_DAYS','DB_CONNECTION','DB_HOST','DB_PORT',
'DB_DATABASE','DB_USERNAME','DB_CONNECTION_SQLSRV','DB_HOST_SQLSRV','DB_PORT_SQLSRV',
'DB_DATABASE_SQLSRV','DB_USERNAME_SQLSRV','DB_PASSWORD_SQLSRV','SESSION_DRIVER','SESSION_LIFETIME',
'SESSION_ENCRYPT','SESSION_PATH','SESSION_DOMAIN','BROADCAST_CONNECTION','FILESYSTEM_DISK',
'QUEUE_CONNECTION','DB_QUEUE_CONNECTION','CACHE_STORE','CACHE_PREFIX','MEMCACHED_HOST',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','CEOS_WEB_API_TOKEN','NIOTIX_API_BASE_URL',
'NIOTIX_API_KEY','ACCOUNT_ID','SCOPE_ID','DIGITAL_TWIN_ID','SLACK_BOT_USER_OAUTH_TOKEN',
'SLACK_BOT_USER_DEFAULT_CHANNEL','SLACK_WEBHOOK_URL',);
